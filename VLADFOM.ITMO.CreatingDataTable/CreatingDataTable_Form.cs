...
{
    public partial class CreatingDataTable_Form : Form
    {
        private DataSet dataSet; 
        private BindingSource bindingSource1; 
        private BindingSource bindingSource2;
        public CreatingDataTable_Form()
        {
            InitializeComponent();
            MakeDataTables();
        }
        ...
        private void MakeParentTable()
        {
            ...
            //создаём и добавляем первый столбец
            ...
            //создаём и добавляем второй столбец
            column = new DataColumn(); 
            ...
            //создаём и добавляем ограничение первичного ключа по полю "id"
            DataColumn[] PrimaryKeyColumns = new DataColumn[1]; 
            PrimaryKeyColumns[0] = table.Columns["id"]; 
            table.PrimaryKey = PrimaryKeyColumns;

            //создаём dataset и добавляем в него только что созданную таблицу
            dataSet = new DataSet(); 
        ...
        {
            //привязки данных к элементу формы, данными будут являться созданные таблицы
        ...
        private void btnFillChildTable_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = bindingSource1;
        }

        private void btnFillMainTable_Click(object sender, EventArgs e)
        {
