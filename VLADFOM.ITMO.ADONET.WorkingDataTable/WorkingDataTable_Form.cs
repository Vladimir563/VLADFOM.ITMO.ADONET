...
{
    public partial class WorkingDataTable_Form : Form
    {
        public WorkingDataTable_Form()
        {
            InitializeComponent();
        }

        private void WorkingDataTable_Form_Load(object sender, EventArgs e)
        {
        ...
        private void AddRowButton_Click(object sender, EventArgs e)
        {
            ...
            //Присвойте значения каждому столбцу строки:
